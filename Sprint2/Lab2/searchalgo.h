...
public:
    ...
    template<typename T>
    static string DFSIterative(vector<T> &data)
    {

    }

    template<typename T>
    static string DFSRecursive(vector<T> &data)
    {

    }

    template<typename T>
    static string BFSIterative(vector<T> &data)
    {

    }

    template<typename T>
    static string BFSRecursive(vector<T> &data)
    {

    }

    template<typename T>
    static string Dijkstra(vector<T> &data)
    {

    }

    template<typename T>
    static string AStar(vector<T> &data)
    {
